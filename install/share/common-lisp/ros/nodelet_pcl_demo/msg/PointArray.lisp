...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nodelet_pcl_demo-msg:<PointArray> is deprecated: use nodelet_pcl_demo-msg:PointArray instead.")))
...
(cl:defmethod points-val ((m <PointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nodelet_pcl_demo-msg:points-val is deprecated.  Use nodelet_pcl_demo-msg:points instead.")
  (points m))
